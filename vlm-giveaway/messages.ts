export default {
  //////////////// README: ////////////////////////////////////////////
  // Change the text within the quotation marks                     //
  // to customize the messages you want to show.                   //
  // NOTE: Don't delete any commas.                               //
  // All but the last line for errorMessage should have a comma. //
  ////////////////////////////////////////////////////////////////
